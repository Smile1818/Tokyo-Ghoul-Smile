...
public class BlockKoffePlant2 extends ElementsGhoul.ModElement {
	@GameRegistry.ObjectHolder("ghoul:koffeplant2")
	public static final Block block = null;
	public BlockKoffePlant2(ElementsGhoul instance) {
		super(instance, 30);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("ghoul:koffeplant2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("koffeplant2");
			setRegistryName("koffeplant2");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockKoffePlant.block, (int) (3)));
		}

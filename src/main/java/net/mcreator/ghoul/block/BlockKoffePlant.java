...
import net.mcreator.ghoul.procedure.ProcedurePlantkoffe;
...
public class BlockKoffePlant extends ElementsGhoul.ModElement {
	@GameRegistry.ObjectHolder("ghoul:koffeplant")
	public static final Block block = null;
	public BlockKoffePlant(ElementsGhoul instance) {
		super(instance, 28);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("ghoul:koffeplant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("koffeplant");
			setRegistryName("koffeplant");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockKoffePlant.block, (int) (1)));
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedurePlantkoffe.executeProcedure($_dependencies);
			}
		}
	}
}

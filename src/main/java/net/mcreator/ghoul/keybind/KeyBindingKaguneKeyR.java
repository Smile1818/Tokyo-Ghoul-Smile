...
import net.mcreator.ghoul.procedure.ProcedureKaguneKey;
import net.mcreator.ghoul.Ghoul;
import net.mcreator.ghoul.ElementsGhoul;

@ElementsGhoul.ModElement.Tag
public class KeyBindingKaguneKeyR extends ElementsGhoul.ModElement {
	private KeyBinding keys;
	public KeyBindingKaguneKeyR(ElementsGhoul instance) {
		super(instance, 108);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.kagunekeyr", Keyboard.KEY_R, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				Ghoul.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureKaguneKey.executeProcedure($_dependencies);
		}
	}
}

...
import net.mcreator.ghoul.procedure.ProcedureGuiRCVar;
import net.mcreator.ghoul.Ghoul;
import net.mcreator.ghoul.ElementsGhoul;

@ElementsGhoul.ModElement.Tag
public class KeyBindingKeyK extends ElementsGhoul.ModElement {
	private KeyBinding keys;
	public KeyBindingKeyK(ElementsGhoul instance) {
		super(instance, 98);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.keyk", Keyboard.KEY_K, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureGuiRCVar.executeProcedure($_dependencies);
		}
	}
}

...
import net.mcreator.ghoul.procedure.ProcedureAttakRise1;
import net.mcreator.ghoul.Ghoul;
import net.mcreator.ghoul.ElementsGhoul;

@ElementsGhoul.ModElement.Tag
public class KeyBindingKeyZ extends ElementsGhoul.ModElement {
	private KeyBinding keys;
	public KeyBindingKeyZ(ElementsGhoul instance) {
		super(instance, 116);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.keyz", Keyboard.KEY_Z, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureAttakRise1.executeProcedure($_dependencies);
		}
	}
}

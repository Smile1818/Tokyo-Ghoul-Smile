...
import net.mcreator.ghoul.procedure.ProcedureInteraction;
import net.mcreator.ghoul.Ghoul;
import net.mcreator.ghoul.ElementsGhoul;

@ElementsGhoul.ModElement.Tag
public class KeyBindingLKM extends ElementsGhoul.ModElement {
	private KeyBinding keys;
	public KeyBindingLKM(ElementsGhoul instance) {
		super(instance, 236);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.lkm", Keyboard.KEY_I, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureInteraction.executeProcedure($_dependencies);
		}
	}
}

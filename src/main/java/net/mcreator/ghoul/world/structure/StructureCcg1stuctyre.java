...
package net.mcreator.ghoul.world.structure;
...
public class StructureCcg1stuctyre extends ElementsGhoul.ModElement {
	public StructureCcg1stuctyre(ElementsGhoul instance) {
		super(instance, 220);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("ghoul", "ccg1"));
				if (template == null)
					return;

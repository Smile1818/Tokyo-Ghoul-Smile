...
public class ProcedureCCGEff1 extends ElementsGhoul.ModElement {
	public ProcedureCCGEff1(ElementsGhoul instance) {
		super(instance, 89);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure CCGEff1!");
			return;
		}

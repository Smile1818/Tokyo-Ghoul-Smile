...
public class ProcedureKagune4to5 extends ElementsGhoul.ModElement {
	public ProcedureKagune4to5(ElementsGhoul instance) {
		super(instance, 166);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Kagune4to5!");
			return;
		}
		...
		if (((new Object() {
			...
			if (entity instanceof EntityLivingBase) {
				ItemStack _setstack = new ItemStack(ItemCustomKagune.block, (int) (1));

...
import net.mcreator.ghoul.procedure.ProcedureHalhGhoulEff;
...
public class GuiGUIMed extends ElementsGhoul.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiGUIMed(ElementsGhoul instance) {
		super(instance, 122);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ghoul:textures/guimed.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 88, this.guiTop + 20, 50, 20, "start"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureHalhGhoulEff.executeProcedure($_dependencies);
			}
		}
	}

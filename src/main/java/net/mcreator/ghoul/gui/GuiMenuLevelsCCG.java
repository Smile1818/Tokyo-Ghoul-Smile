...
public class GuiMenuLevelsCCG extends ElementsGhoul.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiMenuLevelsCCG(ElementsGhoul instance) {
		super(instance, 109);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ghoul:textures/menulevelsccg.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("CCGXP:", 6, 8, -16764109);
			this.fontRenderer.drawString("" + (GhoulVariables.MapVariables.get(world).RC) + "", 37, 10, -16751002);
			this.fontRenderer.drawString("Points:", 6, 26, -16764109);
			this.fontRenderer.drawString("" + (GhoulVariables.MapVariables.get(world).Points) + "", 42, 28, -16751002);
			...
			this.fontRenderer.drawString("Rang:", 105, 8, -16764109);
			this.fontRenderer.drawString("" + (GhoulVariables.MapVariables.get(world).Rang) + "", 123, 8, -16751002);
		}

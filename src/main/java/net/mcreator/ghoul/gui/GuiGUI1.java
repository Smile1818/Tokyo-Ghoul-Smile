...
import net.mcreator.ghoul.procedure.ProcedureToka;
import net.mcreator.ghoul.procedure.ProcedureGurmanKey;
import net.mcreator.ghoul.procedure.ProcedureGui;
import net.mcreator.ghoul.procedure.ProcedureCustomKaguneKey;
...
public class GuiGUI1 extends ElementsGhoul.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiGUI1(ElementsGhoul instance) {
		super(instance, 45);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ghoul:textures/gui1.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Gui tokyo ghoul", 43, 5, -10092391);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 16, this.guiTop + 29, 50, 20, "Rise"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 97, this.guiTop + 29, 50, 20, "Touka"));
			this.buttonList.add(new GuiButton(2, this.guiLeft + 16, this.guiTop + 65, 60, 20, "Gurman"));
			this.buttonList.add(new GuiButton(3, this.guiLeft + 97, this.guiTop + 65, 60, 20, "Custom"));
		}

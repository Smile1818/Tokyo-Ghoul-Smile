...
import net.mcreator.ghoul.procedure.ProcedureCreateKoffe;
...
public class GuiKoffeGui extends ElementsGhoul.ModElement {
	public static int GUIID = 12;
	public static HashMap guistate = new HashMap();
	public GuiKoffeGui(ElementsGhoul instance) {
		super(instance, 149);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 17, 32) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemCup.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 71, 32) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemKoffe2.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 143, 32) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 0 + 8 + sj * 18, 2 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 0 + 8 + si * 18, 2 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ghoul:textures/koffegui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Cup", 16, 13, -10066330);
			this.fontRenderer.drawString("Koffe", 70, 13, -10066330);
			this.fontRenderer.drawString("Water:" + (GhoulVariables.MapVariables.get(world).water) + "", 4, 53, -16750849);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 106, this.guiTop + 31, 20, 20, "Go"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureCreateKoffe.executeProcedure($_dependencies);
			}
		}
	}

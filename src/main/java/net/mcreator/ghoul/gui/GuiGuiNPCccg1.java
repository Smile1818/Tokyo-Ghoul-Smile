...
import net.mcreator.ghoul.procedure.ProcedureOnClickYes;
import net.mcreator.ghoul.procedure.ProcedureOnClickNO;
...
public class GuiGuiNPCccg1 extends ElementsGhoul.ModElement {
	public static int GUIID = 13;
	public static HashMap guistate = new HashMap();
	public GuiGuiNPCccg1(ElementsGhoul instance) {
		super(instance, 221);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ghoul:textures/guinpcccg1.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Do you want to become a CCG Investigator?", 17, 7, -10066330);
		}
		...
		public void initGui() {
			super.initGui();
			this.guiLeft = (this.width - 232) / 2;
			this.guiTop = (this.height - 50) / 2;
			Keyboard.enableRepeatEvents(true);
			this.buttonList.clear();
			this.buttonList.add(new GuiButton(0, this.guiLeft + 125, this.guiTop + 25, 30, 20, "Yes"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 71, this.guiTop + 25, 20, 20, "No"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureOnClickYes.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				ProcedureOnClickNO.executeProcedure($_dependencies);
			}
		}
	}

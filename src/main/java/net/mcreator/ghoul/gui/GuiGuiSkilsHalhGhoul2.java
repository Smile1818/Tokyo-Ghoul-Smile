...
public class GuiGuiSkilsHalhGhoul2 extends ElementsGhoul.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiGuiSkilsHalhGhoul2(ElementsGhoul instance) {
		super(instance, 134);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ghoul:textures/guiskilshalhghoul2.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("ghoul:textures/kaguneons.png"));

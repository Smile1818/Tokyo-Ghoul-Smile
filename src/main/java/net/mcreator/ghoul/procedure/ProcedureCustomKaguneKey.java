...
public class ProcedureCustomKaguneKey extends ElementsGhoul.ModElement {
	public ProcedureCustomKaguneKey(ElementsGhoul instance) {
		super(instance, 118);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure CustomKaguneKey!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure CustomKaguneKey!");
			return;
		}

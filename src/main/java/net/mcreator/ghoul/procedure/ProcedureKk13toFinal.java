...
public class ProcedureKk13toFinal extends ElementsGhoul.ModElement {
	public ProcedureKk13toFinal(ElementsGhoul instance) {
		super(instance, 186);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Kk13toFinal!");
			return;
		}
		...
		if (((new Object() {
			...
			if (entity instanceof EntityLivingBase) {
				ItemStack _setstack = new ItemStack(ItemKagune.block, (int) (1));

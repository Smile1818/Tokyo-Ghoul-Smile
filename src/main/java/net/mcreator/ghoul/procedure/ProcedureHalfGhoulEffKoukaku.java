...
public class ProcedureHalfGhoulEffKoukaku extends ElementsGhoul.ModElement {
	public ProcedureHalfGhoulEffKoukaku(ElementsGhoul instance) {
		super(instance, 188);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure HalfGhoulEffKoukaku!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure HalfGhoulEffKoukaku!");
			return;
		}
		...
		GhoulVariables.MapVariables.get(world).KaguneType = (String) "Koukaku";
		GhoulVariables.MapVariables.get(world).syncData(world);
		GhoulVariables.MapVariables.get(world).KaguneName = (String) "Gurman";
		GhoulVariables.MapVariables.get(world).syncData(world);
		if (entity instanceof EntityPlayerMP) {

...
public class ProcedureGui extends ElementsGhoul.ModElement {
	public ProcedureGui(ElementsGhoul instance) {
		super(instance, 48);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Gui!");
			return;
		}

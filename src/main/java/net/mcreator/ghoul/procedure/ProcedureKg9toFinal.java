...
public class ProcedureKg9toFinal extends ElementsGhoul.ModElement {
	public ProcedureKg9toFinal(ElementsGhoul instance) {
		super(instance, 219);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Kg9toFinal!");
			return;
		}
		...
		if (((new Object() {
			...
			if (entity instanceof EntityLivingBase) {
				ItemStack _setstack = new ItemStack(ItemGurman.block, (int) (1));

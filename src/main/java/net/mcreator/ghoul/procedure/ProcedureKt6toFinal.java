...
public class ProcedureKt6toFinal extends ElementsGhoul.ModElement {
	public ProcedureKt6toFinal(ElementsGhoul instance) {
		super(instance, 201);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Kt6toFinal!");
			return;
		}
		...
		if (((new Object() {
			...
			if (entity instanceof EntityLivingBase) {
				ItemStack _setstack = new ItemStack(ItemKaguneToka.block, (int) (1));
